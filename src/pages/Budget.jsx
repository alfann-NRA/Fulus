    ...
    <div className="pb-20 fade-in">
      ...
      <div className="mb-6">
        <div className="h-2 bg-slate-100 rounded-full mb-3 overflow-hidden">
          <div className="h-full bg-purple-300 rounded-full transition-all duration-1000" style={{ width: `${progressPct}%` }}></div>
        </div>
      ...
      <div className="space-y-4">
        {displayBudgets.map((b, i) => (
          <div key={i} className="bg-white rounded-[2rem] p-5 shadow-soft border border-slate-50 flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="h-1.5 bg-slate-100 rounded-full mb-1 overflow-hidden">
                <div className="h-full bg-purple-300 rounded-full transition-all duration-1000" style={{ width: `${b.pct}%` }}></div>
              </div>
